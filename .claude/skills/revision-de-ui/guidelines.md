<!--
  COPIA VERSIONADA. No editar a mano.

  Origen : https://raw.githubusercontent.com/vercel-labs/web-interface-guidelines/main/command.md
  Bajado : 2026-08-30
  SHA-256: 5a775e6411f790f518dbc9c1fa7c50a89e6873502d9a3530a6eb223a590bcfe8
  Licencia: ver el repositorio de origen (vercel-labs/web-interface-guidelines)

  Para actualizar: volver a bajar el archivo, revisar el diff y commitear el
  cambio como una decisión deliberada. Ver ../../../CLAUDE.md, sección Skills.
-->
